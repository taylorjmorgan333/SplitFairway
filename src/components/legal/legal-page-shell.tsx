      ...
      <main className="py-14 sm:py-20">
        <Container className="max-w-3xl">
          ...
          <Alert variant="info" className="mt-6">
            <strong>Draft — not final.</strong> This page is placeholder legal text written for a
            private beta, not a finished policy. It has not been reviewed by an attorney and
