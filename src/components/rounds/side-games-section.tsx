...
/** The dollar-value + accept-notice fields, shown inline in either create form once "Play for money" is checked. */
function MonetarySection({ show }: { show: boolean }) {
  if (!show) return null;
  return (
